...
const STICKER_SHEET_IMG =
  getStepperImg("sticker sheet") || getStepperImg("sticker");
...
export function QuantexPage() {
  ...
  return (
    <section className="quantex-page projects-layout">
      <div className="quantec-opening-bg"></div>
      ...
      <section className="overview">
        <h4>Overview</h4>
        <p>
          Quantex was born from a simple observation: the traditional way of
          exchanging money is a bit of a chore. Whether people are too busy to
          visit a physical exchange shop, can't find one nearby, or simply
          prefer the security of digital over physical cash, there is a clear
          need for a more flexible solution.
          <br />
          <span className="p-gap" aria-hidden="true" />I designed this
          multi-currency wallet to give travellers total control. With just a
          few taps, users can convert their funds at fair rates and immediately
          use their device to pay at a cashier or online, anywhere in the world.
        </p>
      ...
      >
        <h3
          id="ideation-user-stories-heading"
          className="ideation-user-stories-heading"
        >
        ...
        <div className="ideation-block">
          ...
          <p className="ideation-block-p">
            I drafted user stories to define the core needs of my personas.
            These statements ensured that every feature addressed a specific
            goal, such as Drake&apos;s need for efficiency as a single parent or
            Natasha&apos;s requirement for spontaneity and simplicity.
          </p>
            ...
            <div className="ideation-sticky-notes">
              {STEPPER_STICKY_NOTE_IMAGES.map((src, index) => (
                <img
                  ...
                  src={src}
                  alt=""
                  className="ideation-sticky-note-img"
                />
              ))}
            </div>
          )}
        ...
        <div className="ideation-block">
          ...
          <p className="ideation-block-p">
            ...
            on accessibility, speed, and the removal of physical errands.
          </p>
          <ul className="ideation-hmw-list">
            <li>
              How might we eliminate the need for travellers to visit physical
              exchange shops before or during their trip?
            </li>
            <li>
              How might we design a currency exchange process that is intuitive
              for users with low technical knowledge or memory hurdles?
            </li>
            <li>
              How might we help a busy parent complete a secure transaction in
              seconds?
            </li>
          </ul>
        </div>
      ...
      >
        <h3 id="ideation-mapping-heading" className="ideation-mapping-heading">
          Mapping the journey
        </h3>
        <h4 className="ideation-mapping-subtitle">Sitemap</h4>
        <p className="ideation-mapping-p">
          I designed a sitemap to establish a clear and shallow information
          architecture. By keeping the navigation simple, I ensured that users
          could reach the exchange flow in a single tap.
        </p>
        {PROJECT_IMAGE && (
          <div className="ideation-mapping-fig">
            <img
              src={PROJECT_IMAGE}
              alt="Quantex sitemap - Homepage, Profile, Exchange, Wallet, Rate History"
              className="ideation-mapping-img"
            />
          </div>
        )}
      </section>
      ...
      >
        <h3
          id="design-wireframes-heading"
          className="design-wireframes-heading"
        >
          Sketches to low-fidelity
        </h3>
        <h4 className="design-wireframes-subtitle">Paper wireframes</h4>
        <p className="design-wireframes-p">
          I used paper wireframes to explore a layout that removes complexity
          for those less familiar with digital finance. By simplifying the steps
          between currency selection and the final exchange, I ensured the
          process feels intuitive and efficient, regardless of the user&apos;s
          technical experience.
        </p>
        <ul className="design-wireframes-notes">
          <li>
            <span>a.</span> Large, clear input fields allow users to quickly
            choose their currencies without searching through dense menus.
          </li>
          <li>
            <span>b.</span> Positioning the primary action at the bottom of the
            screen ensures it sits within the &apos;thumb zone&apos;. This
            ergonomic choice improves accessibility and allows for a more
            comfortable one-handed experience for all users.
          </li>
        </ul>
        {PAPER_WIREFRAME_IMG && (
          <div className="design-wireframes-fig">
            <img
              src={PAPER_WIREFRAME_IMG}
              alt="Paper wireframe - select amount screen for currency exchange"
              className="design-wireframes-img"
            />
          </div>
        )}

        <h4 className="design-wireframes-subtitle design-wireframes-subtitle--block">
          Low-fidelity wireframes
        </h4>
        <p className="design-wireframes-lofi-p">
          I transitioned my paper sketches into digital low-fidelity wireframes
          to focus on visual hierarchy and flow. During this stage, I refined
          the layout to ensure the core exchange process remained the central
          focus, allowing me to test the usability of the interface before
      ...
      >
        ...
        <div className="design-visual-identity-block">
          ...
          <p className="design-visual-identity-p">
            I designed these components to keep the experience intuitive and
            approachable. By using familiar iconography and a clean visual
            hierarchy, I ensured the interface feels friendly and simple to
            navigate, removing the &apos;intimidation factor&apos; usually found
            in banking apps.
            <span>Accessibility in mind</span> I used universally recognised
            icons and high-contrast colours to support users who may find
            text-heavy interfaces overwhelming. This approach ensures that even
            at a glance, the app&apos;s functions remain clear and accessible to
            everyone.
          </p>
          {STICKER_SHEET_IMG && (
            <div className="design-visual-identity-fig">
              <img
                ...
                alt="Style guide - Quantex typography, colours, buttons, inputs, icons"
                className="design-visual-identity-img secondary"
              />
            </div>
          )}
        </div>
        ...
        <div className="design-hifi-intro">
          <h3 id="design-hifi-heading" className="design-hifi-heading">
            High-fidelity mockups
          </h3>
          <h4 className="design-hifi-subtitle">Iterations</h4>
          <p className="design-hifi-p">
            After testing the initial designs, I identified several areas where
            the user flow could be further simplified. These iterations focus on
            refining the layout based on direct user feedback, ensuring that the
            most important tasks ΓÇö like checking rates and finalising an
      ...
      <section className="design-hifi" aria-labelledby="design-hifi-heading">
        ...
        <div className="design-hifi-before-after">
          ...
          <p className="design-hifi-ba-p before">
            The original layout relied on a vertical list of buttons, requiring
            users to navigate away from the home screen to view essential data
            like rate trends or transaction history.
          </p>
          {BEFORE_HOMEPAGE_IMG && (
            <img
              src={BEFORE_HOMEPAGE_IMG}
              alt="Quantex app homepage - before redesign"
          ...
          <p className="design-hifi-ba-p after">
            I redesigned the home screen to feature interactive widgets that
            display live data. By bringing the wallet balance and rate graph to
            the forefront, users can get an instant overview of their finances
            without additional navigation.
          </p>
          {AFTER_HOMEPAGE_IMG && (
            <img
              src={AFTER_HOMEPAGE_IMG}
              alt="Quantex app homepage - after redesign"
        ...
        <div className="design-hifi-before-after">
          ...
          <p className="design-hifi-ba-p before">
            ...
            any button characteristics. This made it unclear if the element was
            interactive or simply a visual divider between the currency fields.
          </p>
          {BEFORE_HOMEPAGE_2_IMG && (
            <img
              src={BEFORE_HOMEPAGE_2_IMG}
              alt="Quantex exchange screen - before"
              className="design-hifi-ba-img before"
            />
          )}
          {(useSmallLine ? SMALL_LINE_IMG : LINE_IMG) && (
          ...
          <h4 className="design-hifi-ba-title after">After</h4>
          <p className="design-hifi-ba-p after">
            I redesigned the arrows as a clear, shadowed button to signal
            interactivity. This change follows the app&apos;s established button
            styles, making it intuitive for users to tap and switch the exchange
            direction instantly.
          </p>
          {AFTER_HOMEPAGE_2_IMG && (
            <img
              src={AFTER_HOMEPAGE_2_IMG}
              alt="Quantex exchange screen - after"
              className="design-hifi-ba-img after"
            />
          )}
        </div>
        ...
        <div className="design-hifi-before-after">
          <h4 className="design-hifi-ba-title before">Before</h4>
          <p className="design-hifi-ba-p before">
            The initial green brand colour failed to meet the WCAG AA contrast
            standards for accessibility. The light text on the green background
            made primary actions difficult to read for users with low vision.
          </p>
          {BEFORE_HOMEPAGE_3_IMG && (
            <img
              src={BEFORE_HOMEPAGE_3_IMG}
              alt="Quantex transaction summary - before accessibility update"
              className="design-hifi-ba-img before"
            />
          )}
          {(useSmallLine ? SMALL_LINE_IMG : LINE_IMG) && (
          ...
          <h4 className="design-hifi-ba-title after">After</h4>
          <p className="design-hifi-ba-p after">
            I updated the brand palette to a deeper blue, which passed the
            WebAIM contrast test with a higher ratio. This change ensures that
            all text and icons are sharp and legible, providing a more inclusive
            experience without sacrificing the professional look of the app.
          </p>
          {AFTER_HOMEPAGE_3_IMG && (
            <img
              src={AFTER_HOMEPAGE_3_IMG}
              alt="Quantex transaction summary - after accessibility update"
              className="design-hifi-ba-img after"
            />
          )}
        </div>
        ...
        <div className="design-hifi-final">
          ...
          <p className="design-hifi-final-p">
            ...
            desktop and mobile web versions, I made sure the app feels the same
            no matter where you use it. Whether a user is at home on a PC, using
            a mobile browser, or opening the app while travelling, the layout
            remains familiar and easy to navigate.
          </p>
          {FINAL_DESIGN_IMG && (
            <img
              src={FINAL_DESIGN_IMG}
              alt="Quantex final design - Payment received screens across mobile and web"
        ...
        <div className="design-hifi-desktop">
          ...
          <p className="design-hifi-desktop-p">
            ...
            By keeping the interface centred with generous margins, the app
            remains easy to focus on and doesn&apos;t feel stretched or
            overwhelming on a larger monitor.
          </p>
          <p className="design-hifi-desktop-p">
            Using wide margins on the desktop version keeps the content in a
            narrow, readable column. This prevents long lines of text which can
